...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/tokens/models", middleware.AdminAuth(), controller.GetQuotaDatesByTokenModel)
	dataRoute.GET("/token-names", middleware.AdminAuth(), controller.GetTokenNames)
